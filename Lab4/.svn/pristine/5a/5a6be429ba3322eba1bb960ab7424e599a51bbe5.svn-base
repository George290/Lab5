        	...
        	if (e.getSource() == choice){
        		...
        		if ((String)choice.getSelectedItem() == "Сокращение") {
        			...
        			if (!isFractionNum2.isInput) {
        				JOptionPane.showMessageDialog(null, "Ошибка! Некорректный ввод дроби");
        			} else {
            		...
            		if (!isFractionNum1.isInput && !isFractionNum2.isInput) {
            			JOptionPane.showMessageDialog(null, "Ошибка! Некорректный ввод 1 и 2 дроби");
            		} else {
            			if (!isFractionNum1.isInput && isFractionNum2.isInput) {
            				JOptionPane.showMessageDialog(null, "Ошибка! Некорректный ввод 1 дроби");
            			} else {
            				if (isFractionNum1.isInput && !isFractionNum2.isInput) {
            					JOptionPane.showMessageDialog(null, "Ошибка! Некорректный ввод 2 дроби");
            				} else {
